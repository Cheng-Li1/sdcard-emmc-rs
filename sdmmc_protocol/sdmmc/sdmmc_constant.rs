...
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_LEGACY: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_LEGACY;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_SDHS: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_SDHS;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_UHS_SDR12: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_UHS_SDR12;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_UHS_SDR25: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_UHS_SDR25;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_UHS_SDR50: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_UHS_SDR50;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_UHS_SDR104: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_UHS_SDR104;
pub const SD_SWITCH_FUNCTION_GROUP_ONE_CHECK_UHS_DDR50: u8 = 1 << SD_SWITCH_FUNCTION_GROUP_ONE_SET_UHS_DDR50;
